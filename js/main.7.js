...
function filter()
{
  ...
  if (isNaN(Number($('#filter').val())))
  {
    ...
    get_filter('http://jakebarnes.com.au/ISteamUser/ResolveVanityURL/v0001/?key=80425AE7E1845E2B033ECA38E8F7BCBE&vanityurl=' + $('#filter').val(), 'Resolving username...', function (data)
    {
      ...
      {
        get_filter('http://jakebarnes.com.au/ISteamUserStats/GetUserStatsForGame/v0002/?appid=218620&key=80425AE7E1845E2B033ECA38E8F7BCBE&steamid=' + data.response.steamid, 'Fetching user stats...', function (data)
        {
  ...
  else
  {
    ...
    get_filter('http://jakebarnes.com.au/ISteamUserStats/GetUserStatsForGame/v0002/?appid=218620&key=80425AE7E1845E2B033ECA38E8F7BCBE&steamid=' + $('#filter').val(), 'Fetching user stats...', function (data)
    {
      if (data.playerstats != undefined)
      {
        filter_status('success', 'Done.');
